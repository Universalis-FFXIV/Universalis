...
class UserAlertEventsApi(object):
    ...
    def api_v2_alert_events_id_get(self, id, **kwargs):  # noqa: E501
        """Retrieves an alert event. Requires the session cookie to be set correctly.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_alert_events_id_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: (required)
        :return: UserAlertEventView
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_alert_events_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_alert_events_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_alert_events_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Retrieves an alert event. Requires the session cookie to be set correctly.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_alert_events_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_alert_events_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `api_v2_alert_events_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='UserAlertEventView',  # noqa: E501
