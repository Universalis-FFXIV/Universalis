...
class CurrentUserApi(object):
    ...
    def api_v2_usersme_get(self, **kwargs):  # noqa: E501
        """Retrieves the current user. Requires the session cookie to be set correctly.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_usersme_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_usersme_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_usersme_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_v2_usersme_get_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves the current user. Requires the session cookie to be set correctly.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_usersme_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_usersme_get" % key
                )
            params[key] = val
        del params['kwargs']
