...
from swagger_client.api.user_alerts_api import UserAlertsApi  # noqa: E501
from swagger_client.rest import ApiException


class TestUserAlertsApi(unittest.TestCase):
    """UserAlertsApi unit test stubs"""

    def setUp(self):
        self.api = swagger_client.api.user_alerts_api.UserAlertsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_api_v2_alerts_id_get(self):
        """Test case for api_v2_alerts_id_get

        Retrieves an alert. Requires the session cookie to be set correctly.  # noqa: E501
        """
        pass

    def test_api_v2_alerts_post(self):
        """Test case for api_v2_alerts_post
