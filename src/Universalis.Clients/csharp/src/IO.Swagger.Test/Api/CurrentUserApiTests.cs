...
namespace IO.Swagger.Test
{
    ...
    public class CurrentUserApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' CurrentUserApi
            //Assert.IsInstanceOfType(typeof(CurrentUserApi), instance, "instance is a CurrentUserApi");
        }

        
        /// <summary>
        /// Test ApiV2UsersmeGet
        /// </summary>
        [Test]
        public void ApiV2UsersmeGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ApiV2UsersmeGet();
            //Assert.IsInstanceOf<UserView> (response, "response is UserView");
        }
