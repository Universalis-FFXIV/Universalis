...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HistoryMultiViewV2 :  IEquatable<HistoryMultiViewV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryMultiViewV2" /> class.
        /// </summary>
        ...
        public HistoryMultiViewV2(List<int?> itemIDs = default(List<int?>), Dictionary<string, HistoryView> items = default(Dictionary<string, HistoryView>), int? worldID = default(int?), string dcName = default(string), List<int?> unresolvedItems = default(List<int?>), string worldName = default(string))
        {
        ...
        public Dictionary<string, HistoryView> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HistoryMultiViewV2 {\n");
        ...
        {
            return this.Equals(input as HistoryMultiViewV2);
        }

        /// <summary>
        /// Returns true if HistoryMultiViewV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoryMultiViewV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryMultiViewV2 input)
        {
            if (input == null)
                return false;
