...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SsoView :  IEquatable<SsoView>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SsoView" /> class.
        /// </summary>
        /// <param name="discord">discord.</param>
        public SsoView(DiscordSsoView discord = default(DiscordSsoView))
        {
        ...
        {
            return this.Equals(input as SsoView);
        }

        /// <summary>
        /// Returns true if SsoView instances are equal
        /// </summary>
        /// <param name="input">Instance of SsoView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SsoView input)
        {
            if (input == null)
                return false;
