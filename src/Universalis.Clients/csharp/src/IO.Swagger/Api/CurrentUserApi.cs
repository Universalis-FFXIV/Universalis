...
namespace IO.Swagger.Api
{
    ...
    public interface ICurrentUserApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of UserView</returns>
        ApiResponse<UserView> ApiV2UsersmeGetWithHttpInfo ();
        ...
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of UserView</returns>
        System.Threading.Tasks.Task<UserView> ApiV2UsersmeGetAsync ();
        ...
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (UserView)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserView>> ApiV2UsersmeGetAsyncWithHttpInfo ();
    ...
    public partial class CurrentUserApi : ICurrentUserApi
    {
        ...
        /// <returns></returns>
        public CurrentUserApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>UserView</returns>
        public UserView ApiV2UsersmeGet ()
        {
             ApiResponse<UserView> localVarResponse = ApiV2UsersmeGetWithHttpInfo();
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of UserView</returns>
        public ApiResponse< UserView > ApiV2UsersmeGetWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("ApiV2UsersmeGet", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<UserView>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (UserView) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UserView)));
        }
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of UserView</returns>
        public async System.Threading.Tasks.Task<UserView> ApiV2UsersmeGetAsync ()
        {
             ApiResponse<UserView> localVarResponse = await ApiV2UsersmeGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (UserView)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserView>> ApiV2UsersmeGetAsyncWithHttpInfo ()
        {
