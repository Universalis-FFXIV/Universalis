...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IUserListsApi : IApiAccessor
    {
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>ApiResponse of UserListView</returns>
        ApiResponse<UserListView> ApiV2ListsListIdGetWithHttpInfo (Guid? listId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>Task of UserListView</returns>
        System.Threading.Tasks.Task<UserListView> ApiV2ListsListIdGetAsync (Guid? listId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>Task of ApiResponse (UserListView)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserListView>> ApiV2ListsListIdGetAsyncWithHttpInfo (Guid? listId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UserListsApi : IUserListsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UserListsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UserListsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public UserListsApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>UserListView</returns>
        public UserListView ApiV2ListsListIdGet (Guid? listId)
        {
             ApiResponse<UserListView> localVarResponse = ApiV2ListsListIdGetWithHttpInfo(listId);
        ...
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>ApiResponse of UserListView</returns>
        public ApiResponse< UserListView > ApiV2ListsListIdGetWithHttpInfo (Guid? listId)
        {
            // verify the required parameter 'listId' is set
            if (listId == null)
                throw new ApiException(400, "Missing required parameter 'listId' when calling UserListsApi->ApiV2ListsListIdGet");

            var localVarPath = "/api/v2/lists/{listId}";
            ...
            {
                Exception exception = ExceptionFactory("ApiV2ListsListIdGet", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<UserListView>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (UserListView) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UserListView)));
        }
        ...
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>Task of UserListView</returns>
        public async System.Threading.Tasks.Task<UserListView> ApiV2ListsListIdGetAsync (Guid? listId)
        {
             ApiResponse<UserListView> localVarResponse = await ApiV2ListsListIdGetAsyncWithHttpInfo(listId);
             return localVarResponse.Data;
        ...
        /// <param name="listId">The ID of the list to retrieve.</param>
        /// <returns>Task of ApiResponse (UserListView)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserListView>> ApiV2ListsListIdGetAsyncWithHttpInfo (Guid? listId)
        {
            // verify the required parameter 'listId' is set
            if (listId == null)
                throw new ApiException(400, "Missing required parameter 'listId' when calling UserListsApi->ApiV2ListsListIdGet");
