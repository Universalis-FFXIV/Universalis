...
class MarketBoardSalesApi(object):
    ...
    def api_v2_history_world_or_dc_item_ids_get(self, item_ids, world_or_dc, **kwargs):  # noqa: E501
        """Retrieves the history data for the requested item and world or data center.  Item IDs can be comma-separated in order to retrieve data for multiple items at once.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_history_world_or_dc_item_ids_get(item_ids, world_or_dc, async_req=True)
        >>> result = thread.get()
        ...
        :param str entries_to_return: The number of entries to return. By default, this is set to 1800, but may be set to a maximum of 999999.
        ...
        :return: HistoryMultiViewV2
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_history_world_or_dc_item_ids_get_with_http_info(item_ids, world_or_dc, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_history_world_or_dc_item_ids_get_with_http_info(item_ids, world_or_dc, **kwargs)  # noqa: E501
            return data

    def api_v2_history_world_or_dc_item_ids_get_with_http_info(self, item_ids, world_or_dc, **kwargs):  # noqa: E501
        """Retrieves the history data for the requested item and world or data center.  Item IDs can be comma-separated in order to retrieve data for multiple items at once.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_history_world_or_dc_item_ids_get_with_http_info(item_ids, world_or_dc, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['item_ids', 'world_or_dc', 'entries_to_return', 'stats_within', 'entries_within']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_history_world_or_dc_item_ids_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('item_ids' not in params or
            ...
            raise ValueError("Missing the required parameter `item_ids` when calling `api_v2_history_world_or_dc_item_ids_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('world_or_dc' not in params or
            ...
            raise ValueError("Missing the required parameter `world_or_dc` when calling `api_v2_history_world_or_dc_item_ids_get`")  # noqa: E501
        ...
        query_params = []
        if 'entries_to_return' in params:
            query_params.append(('entriesToReturn', params['entries_to_return']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/history/{worldOrDc}/{itemIds}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='HistoryMultiViewV2',  # noqa: E501
