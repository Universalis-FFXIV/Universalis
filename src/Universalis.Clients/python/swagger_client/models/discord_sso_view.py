...
class DiscordSsoView(object):
    ...
    def __init__(self, id=None, avatar=None, _configuration=None):  # noqa: E501
        """DiscordSsoView - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this DiscordSsoView.  # noqa: E501

        The user's Discord ID.  # noqa: E501

        :return: The id of this DiscordSsoView.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DiscordSsoView.

        The user's Discord ID.  # noqa: E501

        :param id: The id of this DiscordSsoView.  # noqa: E501
        :type: str
        """
    ...
    @property
    def avatar(self):
        """Gets the avatar of this DiscordSsoView.  # noqa: E501

        The user's Discord avatar.  # noqa: E501

        :return: The avatar of this DiscordSsoView.  # noqa: E501
        :rtype: str
        """
        return self._avatar
    ...
    def avatar(self, avatar):
        """Sets the avatar of this DiscordSsoView.

        The user's Discord avatar.  # noqa: E501

        :param avatar: The avatar of this DiscordSsoView.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DiscordSsoView, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiscordSsoView):
            return False
